...
Make a GET request to [`/api/codeforces`](https://contest-hive.vercel.app/api/codeforces) or [`/api/3`](https://contest-hive.vercel.app/api/3) to get a list of all upcoming Codeforces contests.
